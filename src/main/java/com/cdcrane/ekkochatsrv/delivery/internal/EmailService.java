...
public class EmailService implements EmailUseCase {
    ...
    @Override
    public void sendVerificationEmail(String email, String firstName, Integer verificationCode) {
        ...
        try {
            ...
            message.setSubject("EkkoChat: Verify your account");
